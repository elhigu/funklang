    ...
    <div class="about-inner" role="document">
      ...
      <section class="about-prose">
        ...
        <ul class="about-links">
          ...
          <li><a href="https://github.com/virgill1974/AmigaKlang" target="_blank" rel="noopener">AmigaKlang on GitHub</a></li>
          <li><a href="https://github.com/elhigu/funklang" target="_blank" rel="noopener">funklang source and issue tracker on GitHub</a></li>
        </ul>
